...
final class CompteClientController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(CompteClientForm::class, $compteClient);
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$compteClient->getId(), $request->getPayload()->getString('_token'))) {
